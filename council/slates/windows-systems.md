...
- `settings.json` on disk: `{"saveDir":"C:\Users\<you>\Videos\\ShadowCast","volume":0.9,"audioDelayMs":0,"audioFix":"off"}` — **no `audioEngine` key**, although `Program.cs:697` always writes one. The file therefore predates the current build.
